# Generated by Django 2.0.10 on 2021-05-11 04:37
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('circles', '0004_auto_20210511_0137'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('used_by', models.ForeignKey(help_text='User that used the code to enter in to the circle', on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
