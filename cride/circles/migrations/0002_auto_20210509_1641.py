# Generated by Django 2.0.10 on 2021-05-09 16:41
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('remainig_invitation', models.PositiveSmallIntegerField(default=0)),
                ('rides_taken', models.PositiveIntegerField(default=0)),
                ('rides_offered', models.PositiveIntegerField(default=0)),
                ('is_active', models.BooleanField(default=True, help_text='Only actvie users are allowed to interactive in the circle.', verbose_name='active status')),
